  ...
  <div className="w3-top">
    <div className="w3-bar w3-theme-d2 w3-left-align w3-large">
      ...
      <a href="#" className="w3-bar-item w3-button w3-hide-small w3-right w3-padding-large w3-hover-white" title="My Account">
        <img src="./images/avatar2.png" className="w3-circle" style={{height: '23px', width: '23px'}} alt="Avatar" />
      </a>
    </div>
  </div>
    ...
    <div className="w3-row">
      ...
      <div className="w3-col m3">
        ...
        <div className="w3-card w3-round w3-white">
          <div className="w3-container">
            ...
            <p className="w3-center"><img src="./images/avatar3.png" className="w3-circle" style={{height: '106px', width: '106px'}} alt="Avatar" /></p>
            <hr />
            ...
            <div id="Demo3" className="w3-hide w3-container">
              <div className="w3-row-padding">
                ...
                <div className="w3-half">
                  <img src="./images/lights.jpg" style={{width: '100%'}} className="w3-margin-bottom" />
                </div>
                <div className="w3-half">
                  <img src="./images/nature.jpg" style={{width: '100%'}} className="w3-margin-bottom" />
                </div>
                <div className="w3-half">
                  <img src="./images/mountains.jpg" style={{width: '100%'}} className="w3-margin-bottom" />
                </div>
                <div className="w3-half">
      ...
      <div className="w3-col m7">
        ...
        <div className="w3-container w3-card w3-white w3-round w3-margin"><br />
          <img src="./images/avatar2.png" alt="Avatar" className="w3-left w3-circle w3-margin-right" style={{width: '60px'}} />
          ...
          <div className="w3-row-padding" style={{margin: '0 -16px'}}>
            <div className="w3-half">
              <img src="./images/lights.jpg" style={{width: '100%'}} alt="Northern Lights" className="w3-margin-bottom" />
            </div>
            <div className="w3-half">
        ...
        <div className="w3-container w3-card w3-white w3-round w3-margin"><br />
          <img src="./images/avatar5.png" alt="Avatar" className="w3-left w3-circle w3-margin-right" style={{width: '60px'}} />
        ...
        <div className="w3-container w3-card w3-white w3-round w3-margin"><br />
          <img src="./images/avatar6.png" alt="Avatar" className="w3-left w3-circle w3-margin-right" style={{width: '60px'}} />
